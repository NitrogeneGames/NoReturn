...
public class BetterScalableGame implements Game {
	...
	public void recalculateScale() throws SlickException {
		targetWidth = Display.getWidth(); //ONLY CHANGE TO SLICK SOURCE
		...
		if (targetHeight < Display.getHeight()) {
			yoffset = (Display.getHeight() - targetHeight) / 2;
		}
		if (targetWidth < Display.getWidth()) {
			xoffset = (Display.getWidth() - targetWidth) / 2;
		}
